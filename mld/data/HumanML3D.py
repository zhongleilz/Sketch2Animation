...
class HumanML3DDataModule(BaseDataModule):
    ...
    def __init__(self,
        ...
        if phase == "text_only":
            ...
            self.Dataset = Text2MotionDatasetV2_Proj2d #Text2MotionDatasetKeyPoseTrejControl #Text2MotionDatasetPoseTrejControl #Text2MotionDatasetV2
        self.cfg = cfg
    ...
    def feats2rotations(self, features: torch.Tensor) -> torch.Tensor:
        return extract_rotations(features , self.njoints)
